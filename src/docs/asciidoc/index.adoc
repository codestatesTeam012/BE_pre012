...
=== 회원 등록
.http-request
include::{snippets}/post-createMember/http-request.adoc[]

.request-fields
include::{snippets}/post-createMember/request-fields.adoc[]

.http-response
include::{snippets}/post-createMember/http-response.adoc[]

.response-fields
include::{snippets}/post-createMember/response-fields.adoc[]
